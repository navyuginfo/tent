    ...
    resetFieldView: function() {
      ...
      if (this.get('fieldView') != null) {
        return Ember.run(function() {
          ...
          _this.set('parentView.content.op', null);
          _this.set('parentView.content.data', null);
