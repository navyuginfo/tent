...
test 'Get abbreviated timezone from utcoffset and name', ->
	...
	equal Tent.Date.getAbbreviatedTZFromUTCOffsetAndName('GMT+0530'), null, 'returns null if no name string is provided and more than one zones exist for the given utc offset'
...
test 'Get full timezone name from utc offset and abbreviation', ->
	...
	equal Tent.Date.getFullTZFromUTCOffsetAndAbbreviation('GMT+0500'), null, 'returns null if more than one zones exist for the given utc offset and no abbreviation is provided'
