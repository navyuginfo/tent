...
Pad.DataStore = Ember.Object.extend
	...
	getColumnsForType: ->
		[
			{id: "id", name: "id", title: "_hID", field: "id", width:15, sortable: true, hidden: true, formatter: "action", formatoptions: {action: "showInvoiceDetails"}, hideable: true},
			{id: "title", name: "title", title: "_hTitle", field: "title", width:5, sortable: true, hideable: false},
			{id: "amount", name: "amount", title: "_hAmount", field: "amount", width:15, editable: true, hideable: false, sortable: true, formatter: "amount", formatoptions:{negative:true}, align: 'right' },
			...
			{id: "%", name: "percentcomplete", title: "_hPercentComplete",field: "percentcomplete", formatter: "percent", width:10, align:'right'},
			{id: "effortdriven", name: "effortdriven", title: "_hEffortDriven", field: "effortdriven", width:10, formatter: "number", formatoptions:{negative:true}},
			...
			{id: "completed", name: "completed", title: "_hCompleted",field: "completed", width:10, hideable: true, formatter: 'checkboxEdit', align: 'center', editable: false}
		]
