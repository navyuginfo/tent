...
$.extend($.jgrid,{
	template : function(format){ //jqgformat
		...
		if (args[3] && args[3].range && args[3].range.rowTitle) {
			args[0] = args[3].range.rowTitle(args[0])
		}
	...
	groupingRender : function (grdata, colspans ) {
		return this.each(function(){
			...
			$.each(grp.groups,function(i,n){
				...
				str += "<tr id=\""+hid+"\" role=\"row\" class= \"ui-widget-content jqgroup ui-row-"+$t.p.direction+" "+clid+"\"><td style=\"padding-left:"+(n.idx * 12) + "px;"+"\" colspan=\""+colspans+"\">"+icon+$.jgrid.template(grp.groupText[n.idx], gv, n.cnt, n.summary, grp)+"</td></tr>";
